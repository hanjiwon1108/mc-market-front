  ...
  return (
    <div>
      <article className="mx-auto w-full px-4 py-8">
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:font-semibold prose-headings:text-gray-900 prose-p:m-0 prose-p:min-h-5 prose-p:text-gray-700 dark:prose-headings:text-white dark:prose-p:text-gray-300">
